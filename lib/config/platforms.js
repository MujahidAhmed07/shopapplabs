export const PLATFORMS_CONFIG = [
  ...
  { id: 'tumblr', name: 'Tumblr', category: 'social', icon: 'Compass', urlPattern: 'https://www.tumblr.com/{}' },
  ...
  { id: 'domain_com', name: '.COM Domain', category: 'domains', icon: 'Globe', urlPattern: 'https://{}.com' },
  { id: 'domain_io', name: '.IO Domain', category: 'domains', icon: 'Globe', urlPattern: 'https://{}.io' },
  { id: 'domain_dev', name: '.DEV Domain', category: 'domains', icon: 'Globe', urlPattern: 'https://{}.dev' },
  { id: 'domain_org', name: '.ORG Domain', category: 'domains', icon: 'Globe', urlPattern: 'https://{}.org' },
  { id: 'domain_net', name: '.NET Domain', category: 'domains', icon: 'Globe', urlPattern: 'https://{}.net' },
  { id: 'domain_co', name: '.CO Domain', category: 'domains', icon: 'Globe', urlPattern: 'https://{}.co' },
  { id: 'domain_ai', name: '.AI Domain', category: 'domains', icon: 'Globe', urlPattern: 'https://{}.ai' }
];
